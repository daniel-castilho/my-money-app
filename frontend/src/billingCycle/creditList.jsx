...
import Grid from "../common/leiaute/grid";
...
const mapToDispatch = dispatch => bindActionCreators({ arrayInsert, arrayRemove }, dispatch);

export default connect(null, mapToDispatch)(CreditList);
